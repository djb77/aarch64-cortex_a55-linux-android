...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/djb77/android/toolchains/aarch64-cortex_a55-linux-android/aarch64-cortex_a55-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
